...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "integrations.plan.noop.applied": "The integration is already applied. No file change is needed.",
  "integrations.plan.noop.disabled": "The integration is already disabled. No file change is needed.",

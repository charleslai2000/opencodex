...
const providers = {
  "openai-apikey": { ...provider("openai-apikey", ["gpt-5.6-luna", "gpt-5.6-terra"]), authMode: "key", apiKey: "$MOCK_UPSTREAM_API_KEY" },
